...
class MyTopo(Topo):
    def __init__(self):
        ...
        self.addLink(s3, s2, bw = 2, delay = '10ms', loss = 50, max_queue_size = 1000, use_htb = True)
...
def perfTest():
    ...
    h2.cmd('iperf -s -u -i 1 > results &')
    print h1.cmd('iperf -c 10.0.0.2 -u -i 1')
    h3.cmd('iperf -c 10.0.0.2 -u -i 1')
    h2.cmd('kill %iperf')
