...
def _handle_portstats_received(event):
    ...
    global s1_p2, s1_p3, s2_p1, s2_p2, s2_p3, s3_p1, s3_p2, s3_p3, s4_p1, s4_p2
    global pre_s1_p2, pre_s1_p3, pre_s2_p1, pre_s2_p2, pre_s2_p3, pre_s3_p1, pre_s3_p2, pre_s3_p3, pre_s4_p1, pre_s4_p2
        ...
        for f in event.stats:
            if int(f.port_no) < 65534:
                ...
                if f.port_no == 3:
                    pre_s2_p3 = s2_p3
                    s2_p3 = f.rx_packets
                    print getTheTime(), "s3_p3(Sent):", (s3_p3 - pre_s3_p3), "s2_p3(Received):", (s2_p3 - pre_s2_p3)
